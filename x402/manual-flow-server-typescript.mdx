---
title: "x402 server flow (TypeScript)"
description: "Build the PAYMENT-REQUIRED response by hand in TypeScript—no server SDK or middleware."
---
...
const SVM_PAY_TO = process.env.SVM_ADDRESS ?? "6oD1Qw1k8Qw1k8Qw1k8Qw1k8Qw1k8Qw1k8Qw1k8Qw1k";
