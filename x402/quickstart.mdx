...
<Tip>
  The free tier supports up to 1,000 settlements. For production, add [PayAI API keys](/x402/api-keys) to unlock unlimited credit-based access -- just two environment variables.
</Tip>
