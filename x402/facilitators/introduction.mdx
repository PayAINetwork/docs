...
The PayAI facilitator includes a free tier for up to 1,000 settlements. For production use, merchants can authenticate with [API keys](/x402/api-keys) to unlock unlimited credit-based access. The x402 SDKs handle JWT generation automatically -- just add two environment variables.
