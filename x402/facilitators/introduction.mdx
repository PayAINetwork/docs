...
To use batch settlement or scale beyond the ordinary exact free allowance (1,000 free credits per receiving wallet, subject to shared-host/IP pools), create a merchant account at [merchant.payai.network](https://merchant.payai.network) for API keys and credits. See [Pricing](/x402/facilitators/pricing) for details.
