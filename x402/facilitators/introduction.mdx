...
When you're ready to scale beyond the free tier (1,000 free settlements), create a merchant account at [merchant.payai.network](https://merchant.payai.network) to top up credits and get API keys. See [Pricing](/x402/facilitators/pricing) for details.
