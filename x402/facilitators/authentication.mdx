...
<Note>
  Authentication is only required beyond the [free tier](/x402/facilitators/pricing) (1,000 free settlements). Create a merchant account at [merchant.payai.network](https://merchant.payai.network) to get your API keys.
</Note>
