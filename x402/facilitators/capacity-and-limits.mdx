...
Each rate has a burst allowance of 5× (short spikes above the sustained rate are absorbed; the edge rejects with **HTTP 429** only once the burst allowance is exhausted). Limits may be tuned over time as capacity grows; any reduction will be announced in advance.
