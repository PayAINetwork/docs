...
<Tip>
  For production use, add [PayAI API keys](/x402/api-keys) to bypass the free tier settlement limit -- just two environment variables in your facilitator config.
</Tip>
