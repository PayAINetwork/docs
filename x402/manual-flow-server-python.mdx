---
title: "x402 server flow (Python)"
description: "Build the PAYMENT-REQUIRED response by hand in Python—no server SDK or middleware."
---
...
SVM_PAY_TO = os.environ.get("SVM_ADDRESS", "6oD1Qw1k8Qw1k8Qw1k8Qw1k8Qw1k8Qw1k8Qw1k8Qw1k")
