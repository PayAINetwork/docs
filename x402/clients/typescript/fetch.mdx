...
You can test your client against a local server by running the [express example](https://github.com/coinbase/x402/tree/main/examples/typescript/servers/express) or the [hono example](https://github.com/coinbase/x402/tree/main/examples/typescript/servers/hono) from the x402 repository.  
