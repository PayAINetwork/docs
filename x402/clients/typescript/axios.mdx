...
<Note>The code and flow below match the [upstream axios client example](https://github.com/coinbase/x402/tree/main/examples/typescript/clients/axios) in the x402 repo. You can use the PayAI starter or clone and run that example directly.</Note>
