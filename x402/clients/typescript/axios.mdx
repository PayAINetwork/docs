...
You can test your client against a local server by running the [express example](/x402/servers/typescript/express.mdx) or the [hono example](/x402/servers/typescript/hono.mdx).  
