...
def custom_payment_selector(
    ...
    # Ignore the network_filter parameter for this example - we hardcode eip155:84532
    _ = network_filter
    ...
    # Filter by eip155:84532 network (Base Sepolia testnet)
    return x402Client.default_payment_requirements_selector(
        accepts,
        network_filter="eip155:84532",
