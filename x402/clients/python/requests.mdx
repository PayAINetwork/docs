...
<Note>The code and flow below match the [upstream requests client example](https://github.com/coinbase/x402/tree/main/examples/python/clients/requests) in the x402 repo. You can clone and run that example directly.</Note>
