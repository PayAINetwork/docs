...
For more examples, see the [x402 examples](https://github.com/coinbase/x402/tree/main/examples) (TypeScript: [Express](https://github.com/coinbase/x402/tree/main/examples/typescript/servers/express), [Hono](https://github.com/coinbase/x402/tree/main/examples/typescript/servers/hono), [Next](https://github.com/coinbase/x402/tree/main/examples/typescript/fullstack/next); Python: [Flask](https://github.com/coinbase/x402/tree/main/examples/python/servers/flask), [FastAPI](https://github.com/coinbase/x402/tree/main/examples/python/servers/fastapi); Go: [Gin](https://github.com/coinbase/x402/tree/main/examples/go/servers/gin)). For protocol details, see the [PayAI x402 docs](/x402/introduction) and [x402 reference](/x402/reference).
