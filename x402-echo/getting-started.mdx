---
description: "Test an x402 client end to end against PayAI's free Echo Merchant without deploying your own server."
---

## Getting Started with X402 Echo Merchant

Use the Echo Merchant to validate your <a href="/x402/clients/introduction">x402 client</a> in minutes—no server to deploy.
