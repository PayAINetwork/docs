---
title: "x402 Echo Merchant Introduction"
description: "Learn how PayAI's free x402 Echo Merchant verifies, settles, fulfills, and refunds test payments for client developers."
---
...
- **Realistic flow**: Exercise discovery, verification, retry with `PAYMENT-SIGNATURE`, and settlement just like a production merchant.
